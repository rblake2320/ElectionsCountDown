      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button variant="outline" size="sm" onClick={handleManualRefresh} className="h-8 px-3">
      ...
      <CardContent className="space-y-4">
        {!hasResults ? (
          ...
          <div className="space-y-3">
            {sortedCandidates.map((candidate, index) => {
              const votePercent =
                totalVotes > 0 ? ((candidate.votesReceived || 0) / totalVotes) * 100 : 0;
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-3">
                      <div className="flex items-center space-x-2">
                        ...
                        {candidate.isWinner && <Trophy className="w-4 h-4 text-green-600" />}
                    ...
                    <div className="text-right">
                      <div className="text-lg font-semibold">{votePercent.toFixed(1)}%</div>
        ...
        {reportingPercent !== undefined && reportingPercent < 100 && (
          <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-blue-700">Precincts Reporting</span>
              <span className="text-sm text-blue-600">{reportingPercent}% complete</span>
            </div>
