  ...
  const handleSubmit = (data: ProfileForm) => {
    const profileData = {
      ...
      employmentHistory: employmentHistory.filter(
        (emp) => emp.company && emp.position,
      ),
      education: education.filter((edu) => edu.institution && edu.degree),
      previousOffices: previousOffices.filter(
        (office) => office.office && office.years,
      ),
      endorsements: endorsements.filter(
        (end) => end.organization && end.description,
      ),
  ...
  return (
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                {...form.register("currentResidence")}
                placeholder="City, State"
              />
            </div>
            <div>
              ...
              <Input
                {...form.register("familyStatus")}
                placeholder="Married with 2 children"
              />
            </div>
          </div>
        </CardContent>
              ...
              <div key={index} className="border p-4 rounded-lg space-y-3 mb-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <Input
                    ...
                    value={emp.years}
                    onChange={(e) =>
                      updateEmployment(index, "years", e.target.value)
                    }
                  />
                </div>
                <Textarea
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="politicalExperience">
              Political Experience Overview
            </Label>
            <Textarea
              ...
              <div key={index} className="border p-4 rounded-lg space-y-3 mb-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Input
                    ...
                    value={office.office}
                    onChange={(e) =>
                      updateOffice(index, "office", e.target.value)
                    }
                  />
                  <Input
                    ...
                    value={office.years}
                    onChange={(e) =>
                      updateOffice(index, "years", e.target.value)
                    }
                  />
                </div>
                <Textarea
                  ...
                  onChange={(e) =>
                    updateOffice(index, "achievements", e.target.value)
                  }
                />
              </div>
            ))}
              ...
              <div key={index} className="border p-4 rounded-lg space-y-3 mb-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <Input
                    ...
                    onChange={(e) =>
                      updateEndorsement(index, "organization", e.target.value)
                    }
                  />
                  <Input
                    placeholder="Date"
                    ...
                    value={end.date}
                    onChange={(e) =>
                      updateEndorsement(index, "date", e.target.value)
                    }
                  />
                </div>
                <Textarea
                  ...
                  onChange={(e) =>
                    updateEndorsement(index, "description", e.target.value)
                  }
                />
              </div>
            ))}
