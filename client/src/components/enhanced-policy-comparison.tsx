              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle className={`text-lg ${colors.text}`}>{candidate.name}</CardTitle>
                  </div>
            ...
            <CardContent className="p-0">
              <div className="divide-y divide-gray-100">
                {candidateDetails.map((candidate, index) => {
                  ...
                  const position =
                    policy?.position || 'Position not available from current sources';
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 mb-1">{candidateDetails.length}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 mb-1">
                {Math.round(
                  candidateDetails.reduce((acc, c) => acc + getDataSourceScore(c), 0) /
