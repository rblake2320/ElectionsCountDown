          ...
          <Tabs defaultValue="economy" className="space-y-4">
            ...
            <TabsContent value="economy" className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "economy")?.questions ||
                    []
                  }
                ...
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "taxes")?.questions ||
                    []
                  }
            ...
            <TabsContent value="healthcare" className="space-y-4">
              <PolicyPositionCard
                ...
                questions={
                  policyTemplate.find((p) => p.id === "healthcare")
                    ?.questions || []
                }
                value={positions.healthcarePosition}
                onChange={(value) =>
                  updatePosition("healthcarePosition", value)
                }
              />
            </TabsContent>
            ...
            <TabsContent value="education" className="space-y-4">
              <PolicyPositionCard
                ...
                questions={
                  policyTemplate.find((p) => p.id === "education")?.questions ||
                  []
                }
            ...
            <TabsContent value="environment" className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "environment")
                      ?.questions || []
                  }
                  value={positions.environmentPosition}
                  onChange={(value) =>
                    updatePosition("environmentPosition", value)
                  }
                />
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "infrastructure")
                      ?.questions || []
                  }
                  value={positions.infrastructurePosition}
                  onChange={(value) =>
                    updatePosition("infrastructurePosition", value)
                  }
                />
              </div>
            </TabsContent>
            ...
            <TabsContent value="social" className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "immigration")
                      ?.questions || []
                  }
                  value={positions.immigrationPosition}
                  onChange={(value) =>
                    updatePosition("immigrationPosition", value)
                  }
                />
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "criminalJustice")
                      ?.questions || []
                  }
                  value={positions.criminalJusticePosition}
                  onChange={(value) =>
                    updatePosition("criminalJusticePosition", value)
                  }
                />
                <PolicyPositionCard
                  title="Social Issues"
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "socialIssues")
                      ?.questions || []
                  }
                  value={positions.socialIssuesPosition}
                  onChange={(value) =>
                    updatePosition("socialIssuesPosition", value)
                  }
                />
                <PolicyPositionCard
                  ...
                  questions={
                    policyTemplate.find((p) => p.id === "foreignPolicy")
                      ?.questions || []
                  }
                  value={positions.foreignPolicyPosition}
                  onChange={(value) =>
                    updatePosition("foreignPolicyPosition", value)
                  }
                />
              </div>
            </TabsContent>
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <Label
            htmlFor={`position-${title.toLowerCase().replace(/\s+/g, "-")}`}
          >
            Your Position
          </Label>
          <Textarea
