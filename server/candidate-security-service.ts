...
export class CandidateSecurityService {
  ...
  checkFeatureAccess(requiredFeature: string) {
    return (req: Request, res: Response, next: NextFunction) => {
      ...
      const allowedFeatures =
        tierFeatures[session.subscriptionTier as keyof typeof tierFeatures] || tierFeatures.basic;
  ...
  private getRequiredTier(feature: string): string {
    ...
    if (['advanced_qa', 'content_management', 'real_time_polling'].includes(feature))
      return 'premium';
    return 'enterprise';
  }
