...
export class AIValidationService {
  ...
  private async checkGovernmentSources(claim: string): Promise<boolean> {
    ...
    try {
      ...
      if (
        claim.toLowerCase().includes("congress") ||
        claim.toLowerCase().includes("representative")
      ) {
        ...
        return (
          verification.includes(".gov") || verification.includes("congress.gov")
        );
      }
