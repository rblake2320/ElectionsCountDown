...
async function integrate2026MidtermData() {
  ...
  try {
    ...
    console.log(
      `📊 Prepared ${electionData.length} 2026 midterm elections for integration`,
    );
    console.log(`   • ${midterm2026Data.house.totalSeats} House seats`);
    console.log(
      `   • ${midterm2026Data.senate.totalSeats} Senate seats (${midterm2026Data.senate.regularSeats} regular + ${midterm2026Data.senate.specialSeats} special)`,
    );
    console.log(
      `   • ${gubernatorialRaces2026.length} Governor races shown (36 total)`,
    );
    console.log(
      `   • ${mayoralRaces2026.length} Major mayoral races shown (30-35 estimated total)`,
    );
